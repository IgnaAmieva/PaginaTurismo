  ...
  es: {
    translation: {
      /* ====== TRADUCCIONES GENERALES (Index) ====== */
          ...
          ustedes: {
            ...
            slide5: "La mejor experiencia en Ojo del Albino y Laguna de los Témpanos.",
            slide6: "Laguna Esmeralda en verano, un paraíso.",
            slide7: "Contemplando la impactante vista de la Laguna de los Témpanos.",
          ...
          lagunaEsmeraldaPage: {
            ...
            infoAdPanel4: "Seguro de accidentes personales con xobertura total.",
            ...
            infoAdTitle2:" Ayúdanos a reducir el impacto de nuestra actividad Por favor, lleva tu botella de agua reutilizable.",
          ...
          ojoAlbinoPage: {
            ...
            sectionPar1: " El Glaciar Ojo del Albino es un trekking de alta dificultad. Se recorren 20 km de caminos agrestes con una desafiante pendiente.A lo largo del recorrido, atravesaremos bosques y diversos terrenos con nieve, hielo y barro, hasta llegar al Ojo del Albino y su majestuoso glaciar homónimo. ",
            sectionMapTitle: "Ubicación en Google Earth",
            sectionMapCaption: "Click para imágenes satelitales",
          ...
          martialPage: {
            ...
            sectionPar1: "Comenzamos el trekking con un ascenso que acompaña la antigua pista de esquí del Martial y se avanza sobre la parte más alta del bosque fueguino.La senda continúa acompañando el arroyo de deshielo proveniente del Glaciar. Luego de pasar el límite de vegetación se camina sobre roca suelta y hielo.",
            sectionPar2: "La senda continúa acompañando el arroyo...",
            sectionMapTitle: "Ubicación en Google Earth",
            sectionMapCaption: "Click para imágenes satelitales",
      ...
      en: {
        ...
        tours: {
            ...
            card1tag: "Low Difficulty",
            card1location: "Laguna Esmeralda",
            card2tag: "High Difficulty",
            card2location: "Glacier and Ojo de Albino Lagoon",
            card3tag: "Medium Difficulty",
            card3location: "Martial Glacier",
            card4tag: "Medium Difficulty",
    ...
    paragraph3:"We remind you that all excursions include round-trip transportation to your accommodation and personal accident insurance.",
        ...
        ustedes: {
            ...
            slide5: "The best experience at Ojo del Albino and Laguna de los Témpanos.",
            slide6: "Laguna Esmeralda in summer, a paradise.",
            slide7: "Admiring the breathtaking view of Laguna de los Témpanos.",
...
infoAdPanel5: "Round-trip transfer to and from the accommodation.",
            ...
            infoAdTitle2: "Help us reduce the impact of our activity. Please bring your reusable water bottle.",
          ...
          tours: {
            title: "Tours, Expeditions & Activities",
            paragraph: "Whether you travel solo, with friends, or family, we have the perfect adventure for you...",
            card1tag: "Easy",
      ...
      paragraph3:"We remind you that all excursions include round-trip transportation to your accommodation and personal accident insurance.",
          ...
          ustedes: {
            title: "Our Travelers!",
            paragraph: "Discover incredible experiences from those who have already embarked on the adventure",
            slide1: "Hiking to the Albino Eye Glacier.",
            slide2: "The stunning Témpanos Lagoon.",
            slide3: "The breathtaking Albino Eye Glacier.",
            slide4: "A family exploring Martial.",
            slide5: "The ultimate adventure in Albino Eye and Témpanos Lagoon.",
            slide6: "Emerald Lagoon in summer, a dream.",
            slide7: "Taking in the spectacular view of Témpanos Lagoon.",
            slide8: "Trekking through Vinciguerra Glacier.",
            slide9: "The beauty of Témpanos Lagoon."
          },
          footer: {
            numero: "Phone",
            mail: "Email",
          ...
          ojoAlbinoPage: {
            ...
            sectionPar1: "Ojo del Albino Glacier is a high-difficulty trek. The route covers 20 km of rugged terrain with a challenging incline. Along the way, we will traverse forests and various terrains with snow, ice, and mud until reaching Ojo del Albino and its majestic namesake glacier.",
            sectionMapTitle: "Location on Google Earth",
            sectionMapCaption: "Click for satellite images",
...
infoAdPanel5: "Round-trip transfer to and from the accommodation.",
      ...
      martialPage: {
        ...
        importantNoteTitle: "IMPORTANT",
        importantNoteParagraph: "If the passenger does not show up or the weather conditions are not suitable, the paid amount will be lost. Changes or cancellations less than 24 hours in advance have a 100% penalty.",
        infoAdTitle2: "Help us reduce the impact of our activity. Please bring your reusable water bottle.",
      ...
      vinciguerraPage: {
        ...
        sectionPar1: "We start in an easily accessible area until we reach the bridge that crosses the Arroyo Grande. Then, the trail enters the Fuegian forest, dominated by lengas and coihues, preparing us for an ascent of approximately 600 meters in elevation gain until we reach the vegetation limit.",
...
ustedes: {
    ...
    slide5: "A melhor experiência no Ojo del Albino e na Laguna de los Témpanos.",
    slide6: "Laguna Esmeralda no verão, um paraíso.",
    slide7: "Contemplando a vista deslumbrante da Laguna de los Témpanos.",
...
infoAdPanel5: "Translado de ida e volta da acomodação.",
            ...
            infoAdTitle2: "Ajude-nos a reduzir o impacto da nossa atividade. Por favor, leve sua garrafa de água reutilizável.",
    ...
    ojoAlbinoPage: {
      ...
      sectionPar1: "O Glaciar Ojo del Albino é uma trilha de alta dificuldade. O percurso cobre 20 km de terrenos acidentados com uma inclinação desafiadora. Ao longo do caminho, atravessaremos florestas e diversos terrenos com neve, gelo e lama, até chegar ao Ojo del Albino e seu majestoso glaciar homônimo.",
      sectionMapTitle: "Localização no Google Earth",
      sectionMapCaption: "Clique para imagens de satélite",
...
infoAdPanel5: "Translado de ida e volta da acomodação.",
    ...
    vinciguerraPage: {
      ...
      sectionPar1: "Começamos em uma área de fácil acesso até chegar à ponte que cruza o Arroyo Grande. Em seguida, a trilha adentra a floresta fueguina, dominada por lengas e coihues, nos preparando para uma subida de aproximadamente 600 metros de desnível até o limite da vegetação.",
